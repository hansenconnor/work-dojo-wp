...
if ( $oceanwp_related_query->have_posts() ) :
	...
	<section id="related-posts" class="<?php echo esc_attr( $classes ); ?>">
		...
		<div class="oceanwp-row clr card-deck">
			...
			<?php foreach( $oceanwp_related_query->posts as $post ) : setup_postdata( $post ); ?>
				...
				// Add classes
				$classes	= array( 'related-post', 'clr', 'card', 'overflow-hidden' );
				...
				<article <?php post_class( $classes ); ?>>
					...
					elseif ( has_post_thumbnail() ) : ?>
						...
						<figure class="card-img-top related-post-media clr m-0">
					...
					<div class="card-body">
                        <h3 class="related-post-title m-0">
